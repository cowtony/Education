...
class Snake(object):
    ...
    def draw(self, screen):    # This definition may not be completed.
...
def main():
    ...
    snake_Eddie = Snake((50, 50))    # Create a Snake object
    ...
    while carryOn:
        ...
        if snake_Eddie.isCollision() is True:
        ...
        # eat apple
        if snake_Eddie.grow(applePos) is True:
        ...
        snake_Eddie.draw(screen)                                                   # Draw snake Eddie
